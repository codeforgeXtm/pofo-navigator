  ...
  return (
    <section className="relative w-full h-screen hero-bg flex justify-center items-start hero-section">
      ...
      <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden w-full">
        ...
        <PaperPlane className="absolute top-[1%] left-[30%] md:top-[30%] md:left-[30%] lg:top-[12%] lg:left-[30%] w-64 h-32 md:w-96 md:h-48 animate-fly" />

        {/* Shooting Star - top right corner */}
        <ShootingStar className="absolute top-[32%] left-[-6%] md:top-[50%] md:left-[3%] lg:top-[42%] lg:left-[6%] w-32 h-16 md:w-48 md:h-24 animate-shoot" />
        ...
        <MusicNote className="absolute top-[36%] right-[14%] md:top-[33%] md:right-[17%] lg:top-[23%] lg:right-[17%] w-8 h-11 md:w-10 md:h-13 animate-sway" />
        ...
        <Crown className="absolute top-[34%] left-[50%] md:top-[49%] md:left-[50%] lg:top-[32%] lg:left-[50%] w-12 h-10 md:w-14 md:h-12 animate-crown" style={{ transform: 'rotate(15deg)' }} />
        ...
        <Lightning className="absolute top-[20%] left-[3%] md:top-[58%] md:left-[29%] lg:top-[45%] lg:left-[34%] w-10 h-20 md:w-12 md:h-24 animate-lightning animation-delay-3000" />

        {/* Clapperboard - left area in the sky, animates open/close */}
        <Clapperboard className="absolute top-[36%] left-[18%] md:top-[58%] md:left-[15%] lg:top-[48%] lg:left-[20%] w-20 h-20 md:w-16 md:h-16 animate-clap" />
        ...
        {/* Hashtag - right side */}
        <Hashtag className="absolute top-[4%] right-[22%] md:top-[60%] md:right-[15%] lg:top-[52%] lg:right-[27%] w-8 h-10 md:w-10 md:h-12 animate-float animation-delay-3000" />

        {/* Bus - on the horizon line, drives across from left to right */}
        <Bus className="absolute top-[39%] md:top-[60%] lg:top-[48%] left-0 w-28 h-18 md:w-36 md:h-24 animate-drive" />
        ...
        <Lightbulb className="absolute top-[20%] right-[4%] md:top-[44%] md:right-[18%] lg:top-[34%] lg:right-[22%] w-10 h-13 md:w-12 md:h-15 animate-glow animate-float-slow animation-delay-2000" />
        ...
        <Star className="absolute top-[30%] right-[18%] md:top-[23%] md:right-[20%] lg:top-[10%] lg:right-[20%] w-3 h-3 md:w-6 md:h-8 animate-twinkle animation-delay-3000" filled />
      </div>
